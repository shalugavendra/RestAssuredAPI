	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("shalugavendra@gmail.com", "shalu@1990");
			}
		});
		// compose message
		try {
		...
		try {
			...
			msg.setReplyTo(InternetAddress.parse("thegavendrathakur@gmail.com", false));

			msg.setSubject("Test Report by Automation", "UTF-8");

			msg.setSentDate(new Date());

			msg.setRecipients(Message.RecipientType.TO, InternetAddress.parse("thegavendrathakur@gmail.com"));
			...
			File f = new File(System.getProperty("user.dir") + "/target/surefire-reports");
